...
public class AdBlockWebViewClientTest {
    ...
    public void testShouldOverrideUrlLoading_BlocksArbitraryFile() {
        ...
        assertTrue("Should block arbitrary file:// URLs", client.shouldOverrideUrlLoading(webView, request));
    }
    ...
    public void testShouldOverrideUrlLoading_AllowsAssets() {
        ...
        assertFalse("Should allow file:///android_asset/", client.shouldOverrideUrlLoading(webView, request));
    }
    ...
    public void testShouldOverrideUrlLoading_AllowsCache() {
        ...
        assertFalse("Should allow cache directory files", client.shouldOverrideUrlLoading(webView, request));
    }
