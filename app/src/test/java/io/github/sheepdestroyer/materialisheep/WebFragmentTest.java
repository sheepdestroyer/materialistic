...
public class WebFragmentTest {
  ...
  public void setUp() throws Exception {
    ...
    java.lang.reflect.Constructor<?> constructor =
        bridgeClass.getDeclaredConstructor(
            String.class,
            Class.forName(
                "io.github.sheepdestroyer.materialisheep.WebFragment$PdfAndroidJavascriptBridge$Callbacks"));
  ...
  public void testBridgeRemovedOnNavigation() {
    assertNotNull(
        "Bridge should be present initially",
    ...
    assertNull(
        "Bridge should be removed on navigation",
        shadowWebView.getJavascriptInterface("PdfAndroidJavascriptBridge"));
  }
  ...
  public void testBridgeRetainedOnPdfLoader() {
    ...
    assertNotNull(
        "Bridge should be retained on PDF loader",
        shadowWebView.getJavascriptInterface("PdfAndroidJavascriptBridge"));
  }
  ...
  public void testBridgeRetainedOnAboutBlank() {
    ...
    // It should be retained
    assertNotNull(
        "Bridge should be retained on about:blank",
        shadowWebView.getJavascriptInterface("PdfAndroidJavascriptBridge"));
  }
}
