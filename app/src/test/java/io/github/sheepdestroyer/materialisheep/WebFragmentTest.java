...
public class WebFragmentTest {
  ...
  public void setUp() {
    ...
    MaterialisticApplication application =
        (MaterialisticApplication) ApplicationProvider.getApplicationContext();
  ...
  public void testJavascriptInterfaceRemovedOnNavigation() {
    ...
    assertNull(
        "JavascriptInterface should be removed on navigation to untrusted URL",
        shadowWebView.getJavascriptInterface("PdfAndroidJavascriptBridge"));
  }
}
