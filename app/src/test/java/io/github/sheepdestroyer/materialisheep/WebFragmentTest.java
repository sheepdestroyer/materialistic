...
public class WebFragmentTest {
  ...
  public void testJavascriptEnabledForLocalContent() {
    ...
    // Check settings
    assertFalse(
        "JavaScript should be disabled for local content",
        webFragment.mWebView.getSettings().getJavaScriptEnabled());
    assertFalse(
        "File access should be disabled", webFragment.mWebView.getSettings().getAllowFileAccess());
  }
  ...
  public void testJavascriptEnabledForRemoteContent() {
    ...
    assertTrue(
        "JavaScript should be enabled for remote content",
        webFragment.mWebView.getSettings().getJavaScriptEnabled());
    assertFalse(
        "File access should be disabled", webFragment.mWebView.getSettings().getAllowFileAccess());
  }
