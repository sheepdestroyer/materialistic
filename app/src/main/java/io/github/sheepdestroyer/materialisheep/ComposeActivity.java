...
public class ComposeActivity extends ThemedActivity {
  ...
  // Pre-compiled regex pattern to avoid dynamic compilation overhead
  private static final java.util.regex.Pattern PATTERN_PARAGRAPH_BREAK =
      java.util.regex.Pattern.compile(PARAGRAPH_BREAK_REGEX);
