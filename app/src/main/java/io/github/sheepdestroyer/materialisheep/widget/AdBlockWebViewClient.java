...
public class AdBlockWebViewClient extends WebViewClient {
    ...
    private boolean isSafeFileUrl(WebView view, String urlPath) {
        ...
        try {
            ...
            String cacheDirCanonical = view.getContext().getApplicationContext().getCacheDir().getCanonicalPath() + File.separator;
            boolean isSafeCacheFile = canonicalPath.startsWith(cacheDirCanonical)
