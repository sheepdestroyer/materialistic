...
public class AdBlocker {
  ...
  // OPTIMIZATION: Use ConcurrentHashMap for lock-free reads, significantly improving parallel
  // performance.
  ...
  private static Boolean loadFromAssets(Context context) throws IOException {
    // OPTIMIZATION: Populate local set first to minimize contention (though ConcurrentHashMap
    // handles it well)
