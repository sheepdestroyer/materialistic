...
public class WebFragment extends LazyLoadFragment
        ...
        if (getActivity() != null) {
          mPdfAndroidJavascriptBridge =
              new PdfAndroidJavascriptBridge(
                  getActivity().getCacheDir().getCanonicalPath(),
                  pdfFilePath,
          ...
          mWebView.addJavascriptInterface(
              mPdfAndroidJavascriptBridge, "PdfAndroidJavascriptBridge");
        }
  ...
  static class PdfAndroidJavascriptBridge {
    ...
    PdfAndroidJavascriptBridge(String cacheDirPath, String filePath, @Nullable Callbacks callback)
      ...
      if (!mFile
          .getCanonicalPath()
          .startsWith(new File(cacheDirPath).getCanonicalPath() + File.separator)) {
