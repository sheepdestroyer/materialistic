...
public class UserServicesClient implements UserServices {
  ...
  // ⚡ Bolt: Pre-compile regular expressions as static constants to avoid compiling on every method
  // call
  private static final java.util.regex.Pattern PATTERN_INPUT =
      java.util.regex.Pattern.compile(REGEX_INPUT);
  private static final java.util.regex.Pattern PATTERN_VALUE =
      java.util.regex.Pattern.compile(REGEX_VALUE);
  private static final java.util.regex.Pattern PATTERN_CREATE_ERROR_BODY =
      java.util.regex.Pattern.compile(REGEX_CREATE_ERROR_BODY);
