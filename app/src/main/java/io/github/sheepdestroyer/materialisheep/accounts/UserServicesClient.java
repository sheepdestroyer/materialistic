...
public class UserServicesClient implements UserServices {
    ...
    private String getInputValue(String html, String name) {
        // extract <input ... >
        // ⚡ Bolt: Use pre-compiled pattern to avoid object allocation and computation overhead inside loop
    ...
    private String parseLoginError(Response response) {
        try {
            // ⚡ Bolt: Use pre-compiled pattern to avoid object allocation and computation overhead
